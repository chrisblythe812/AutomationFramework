 ...
 * <br/>Modified in 5.3
 * <ul>
 * <li>1047673 - Upon typing on the text areas with deny/accept description, enable/disable the action buttons</li>
 * </ul>
 * <br/>Modified in 4.0
 * <ul>
...
var scm_MyCurrentTicket = Class.create(Menu, /** @lends scm_MyCurrentTicket.prototype */{
	 ...
	 * <br/>Modified in 5.4
	 * <ul>
	 * <li>The event could contain 1 or 2 arguments</li>
	 * </ul>
	 * <br/>Modified in 3.0
	 * <ul>
    ...
    noEmployeeSelected: function(eventArgs) {
		var args = getArgs(eventArgs);
		var ident=(args.ident)? args.ident:args;
		
        if (ident === this.employeeSearch.ident) {
			this.disableCreateTicket();
		}
    },
...
scm_MyCurrentTicket.showAcceptDenyStopTransfer = function(caller, ticketId, jsonHrwParams) {
		...
		//since 5.3 - 1047673 - On keyup, if there is a text, activate the corresponding buttons
