...
var StartPage06 = Class.create(Application, {
    ...
    createStandardTemplate: function() {
		...
		ed.buildLink=this.buildLink.bind(this);
    ...
    editNormalContent: function() {
		...
		this.normalContentEditor.buildLink=this.buildLink.bind(this);
	...
	buildLink: function(docId){
		//var url='http://eu2r3edn.euhreka.erp:8003/sap/bc/yglui_httpentry?XML_IN=<EWS><SERVICE>KM_GET_FILE</SERVICE><PARAM><I_V_CONTENT_ID>'+b[0]+'</I_V_CONTENT_ID></PARAM></EWS>';
		//var url = window.location.protocol +'//'+ window.location.hostname+':'+ window.location.port
		var url = window.location.protocol +'//'+ window.location.hostname+':'+ window.location.port+'/sap/bc/yglui_httpentry?XML_IN=<EWS><SERVICE>KM_GET_FILE</SERVICE><PARAM><I_V_CONTENT_ID>'+docId+'</I_V_CONTENT_ID></PARAM></EWS>';
...
saveButton: function() {
    ...
    this.makeAJAXrequest($H({ xml:
		...
		'	<PARAM>' +
		'		<I_V_CONT_ID>' + this.contentID + '</I_V_CONT_ID>' +
		'		<I_V_CONTENT>' + prepareTextToSend(content) + '</I_V_CONTENT>' +
		'	</PARAM>' +
		'</EWS>'
