 ...
 * <li>Do not display error message if there is no HRW user associated</li>
 * </ul>
 * <br/>Modified for 5.2
 * <ul>
...
var HrwEngine = Class.create(/** @lends HrwEngine.prototype */{
	 ...
	 * <li>If there is no login status, it means that there is no HRW user associated</li>
	 * </ul>
	 * <br/>Modified in 5.2
	 * <ul>
    ...
    loggedIn: function(jsonParams){
		...
		//since 5.3 - If there is no login status, it means that there is not HRW agent associated
		if(loginStatus === 'NO_HRW_USER') {
			return;
		}
