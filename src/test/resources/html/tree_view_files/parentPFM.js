...
//                } .bind(this));                
    ...
    */     
    chooseValue: function(value, text, showText) {
        //since we can save as drafs (not saving in backend), we need to do what backend does
        ...
        var value = (!Object.isEmpty(value)) ? prepareTextToShow(value) : '';
        var text = (!Object.isEmpty(text)) ? prepareTextToShow(text) : '';
    ...
    */ 
    viewDetails: function(xml) {
        ...
        for (var i = 0; i < this.fieldPanelsHash.size(); i++) {
            html += "<div id='PFM_detailsTitle_" + i + "' class=''></div><div id='PFM_containerDetails_" + i + "' class='PFM_detailsBodyCss'></div>";
        }
        html += "</div>";
...
//		                resultField._getFieldValues(null, pXml); //not necessary anymore..
