    ...
    */
    ...
    changeToMandatory: function (screen, record, mode, changeMode) {
        if (this.on_nodefault) {
            ...
            if (!Object.isEmpty(screenFields)) {
    ...
    getHtmlUiModeLayer: function (html, buttonsData, screenConfig, register) {
        if (this.mode == "create" || this.mode == "edit") {
            ...
            if (sendDocumentButton) {
                ...
                sendDocumentButton['@showinedit'] = "x";
    ...
    */
    openPopupTContent: function (mode, screenConfig, recordConfig, rowId, settings, updating, modeRestGetContent) {
        ...
        for (var i = 0; i < values.length; i++) {
            ...
            //Set CSS classes for each stream if any inside the pop-up
            this.fixCss(displayer.getHtml());
                ...
                if (showEditButton || showDeleteButton) {
                    ...
                    if (showDeleteButton) {
                        if (global.liteVersion) {
                            ...
                            var label = "";
                            var classes = "application_currentSelection fieldsPanel_deleteButton test_icon";
                        }
                        var editButton = {
                    ...
                    if (showEditButton) {
                        if (global.liteVersion) {
                            ...
                            var label = "";
                            var classes = "application_editSelection fieldsPanel_deleteButton test_icon";
                            var type = "button";
                        }
                        var deleteButton = {
    ...
    paiSuccessTContent: function (mode, screen, record, rowId, paiCallerFieldId, json) {
        ...
        for (var i = 0; i < receivedRow.fields.yglui_str_wid_field.size(); i++) {
            ...
            if (fd.options.id != paiCallerFieldId) {
                ...
                fd.setValue.bind(fd, newValue, newText, true).defer();
        ...
        for (var i = 0; i < this.fieldDisplayers.keys().length; i++) {
            ...
            if (records.keys().include('TRANSLATION')) {
                ...
                for (var j = 0; j < records.keys().length && conti; j++) {
                    ...
                    if ((prepareTextToEdit(field.options.text) != prepareTextToEdit(actualValue.text) && !Object.isEmpty(actualValue.text)) || (field.options.value != actualValue.id) || haveText) {
