 ...
 * <br/>Modified in 5.3
 * <ul>
 * <li>1048346 - Add method to set focus on the ckEditor</li>
 * </ul>
 * <br/>Modified in 5.2
 * <ul>
...
var Scm_HtmlDisplayer = Class.create(/** @lends Scm_HtmlDisplayer.prototype */{
	...
	/**
	 * Set the focus on the current editor
	 * @since 5.3
	 */
	setFocus: function(){
		var editor = this._getEditor();
 ...
 * <br/>Modified in 5.3
 * <ul>
 * <li>Created utility method to enable/disable field</li>
 * </ul>
 * <br/>Modified in 5.1
 * <ul>
...
SCM_SkillDisplayer = Class.create(/** @lends SCM_SkillDisplayer.prototype */{
	...
	/**
	 * Abstract method to disable field
	 * @since 5.3
	 */
	disable: function(){alert('Abstract method')},
	/**
	 * Abstract method to enable field
	 * @since 5.3
	 */
	enable: function(){alert('Abstract method')},
	/**
	 * Abstract method to get data type
	 * @since 5.3
	 */
	getType: function(){alert('Abstract method')},
	/**
...
SCM_SkillDisplayerForArray = Class.create(SCM_SkillDisplayer, /** @lends SCM_SkillDisplayerForArray.prototype */{	
	 ...
	 */
	disable: function(){
		if (this._autocompleter) this._autocompleter.disable();
	},
	/**
	 * Disable the autocompleter
	 * @since 5.3
	 */
	enable: function(){
		if (this._autocompleter) this._autocompleter.enable();
	},
	/**
	 ...
	 */
	getType: function(){
		if (this._autocompleter) return 'autocompleter';
	},
...
SCM_SkillDisplayerForChars = Class.create(SCM_SkillDisplayer, /** @lends SCM_SkillDisplayerForChars.prototype */{	
	 ...
	 */
	disable: function(){
		if (this._inputField) this._inputField.disable();
	},
	/**
	 * Disable the inputField
	 * @since 5.3
	 */
	enable: function(){
		if (this._inputField) this._inputField.enable();
	},
	/**
	 * Return the field tye
	 * @since 5.3
	 * @returns String
	 */
	getType: function(){
		if (this._inputField) return 'inputField';
	},
	destroy: function($super){
		if(this._mask)
			this._mask.destroy();
...
SCM_SkillDisplayerForDates = Class.create(SCM_SkillDisplayer, /** @lends SCM_SkillDisplayerForDates.prototype */{	
	 ...
	 */
	getType: function(){
		if (this._datePicker) return 'datePicker';
	},
	destroy: function($super){
		if (this._datePicker) {
...
SCM_SkillDisplayerForReadOnly = Class.create(SCM_SkillDisplayer, /** @lends SCM_SkillDisplayerForReadOnly.prototype */{	
	 ...
	 */
	getType: function(){
		if (this._element) return 'element';
	},
	destroy: function($super){
