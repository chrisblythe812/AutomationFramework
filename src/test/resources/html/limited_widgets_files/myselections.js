...
var MySelectionsParent = Class.create(EmployeeMenu,
{
    ...
    */
    _initializeSelectElement: function($super, employeeId, hide) {
        $super(employeeId, hide);
            ...
            if (Object.isEmpty(populationForPage) || !populationForPage.complete) {
                ...
                for (var i = 0; i < populationForPage.employees.size(); i++) {
                    ...
                    if (!employee.actual) {
                        ...
                        this._initializeSelectElement(employeeId, employee['@hide']);
                        var employeeElement = this.getEmployeeElement(employeeId);
...
var TreeGroupings = Class.create(origin, {
    ...
    */
    initialize: function ($super, options) {
        ...
        if (!Object.isEmpty(this.options.treeJson)) {
                    this.options.treeJson = null;
                    this.options.groupJson = null;
        }
    ...
    */
    _successGettingTree: function (refreshTree, json) {
        ...
        if (json.EWS.o_no_att_config == 'X') {
            ...
            if (!Object.isEmpty(this.linedTreeObject))
                	this.linedTreeObject._objEvents = null;
            ...
            if (Object.isEmpty(json.EWS.o_tree)) {
                ...
                this.linedTreeObject = new linedTree(this.treeElement, treeStructure, {
                    useCheckBox: true,
                    objEvents: objEvents,
